...
public class ImagenModel
    implements ModelType<ImagenVariation, ImagenVersion, ImagenGenerateMethod> {
  ...
  private ImagenModel(
      @NotNull VerAPI verAPI,
      @NotNull ImagenVariation variation,
      @NotNull ImagenVersion version,
      @NotNull ImagenGenerateMethod generateMethod) {
    this.verAPI = verAPI;
