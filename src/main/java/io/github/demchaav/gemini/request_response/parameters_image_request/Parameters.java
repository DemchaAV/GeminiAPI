...
public record Parameters(
         ...
         * Supported values are 1-4 for most models and 1-8 for `imagegeneration@002`.
         * The default is 4.
         */
        Integer sampleCount,
         ...
         * This is not available when `addWatermark = true`.
         * It is also ineffective when `enhancePrompt = true`.
         */
        Integer seed,

        /**
         * Enables prompt enhancement through an LLM before generation.
         * The default is `true` when the model supports it.
         * Currently supported only by `imagen-3.0-generate-002`.
         */
        Boolean enhancePrompt,

        /**
         * Description of elements the generated image should avoid.
         * Token limits vary by model and this field is not supported by `imagen-3.0-generate-002`.
         */
        String negativePrompt,

        /**
         * Image aspect ratio.
         * The default is `1:1`, while the accepted values depend on the model family.
         */
        String aspectRatio,
        ...
        /**
         * Image style for `imagegeneration@002`.
         * Supported values include `photograph`, `digital_art`, `landscape`, `sketch`,
         * `watercolor`, `cyberpunk`, and `pop_art`.
         */
        String sampleImageStyle,

        /**
         * Person generation policy.
         * Supported by `imagen-3.0-*` and `imagegeneration@006`.
         */
        ...
        /**
         * Whether to add an invisible watermark to the generated image.
         * The default depends on the selected model.
         */
