...
public record Citation(
    ...
    /**
     * The URL of a citation source. Examples of a URL source might be a news website or a GitHub
     * repository.
     */
    String uri,

    /**
     * The title of a citation source. Examples of source titles might be that of a news article or
     * a book.
     */
    String title,
    ...
    /** The date a citation was published. Valid formats are YYYY, YYYY-MM, and YYYY-MM-DD. */
