...
public enum FinishReason {
  ...
  /**
   * Token generation was stopped because the response was flagged for safety reasons. Note that
   * Candidate.content is empty if content filters block the output.
   */
  ...
  /**
   * Token generation was stopped because the response was flagged for prohibited content, such as
   * child sexual abuse material (CSAM).
   */
  FINISH_REASON_PROHIBITED_CONTENT,

  /**
   * Token generation was stopped because the response was flagged for sensitive personally
